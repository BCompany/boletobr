...
//Now this method is a generic method and was passed to the BoletoGerador.css
//For now it is used for all banks
//namespace BoletoBrPrint.Bancos
//{
    //public class GeradorBoletoSantanderPDF: GeradorBoleto
    //{
    //    //methods above not exists
    //    #region Refactor to Util class
...
//    #region Refactor to GeradorBoleto class
...
//    //        document.GerarLinhaBoleto(line, receiptTable);
...
//    //    for (int line = 2; line <= 5; line++)
//    //        document.GerarLinhaBoleto(line, documentTable);
...
//    //    // line 6
//    //    document.GerarLinhaBoleto(6, documentTable);
